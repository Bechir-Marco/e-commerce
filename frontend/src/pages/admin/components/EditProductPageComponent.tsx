...
type EditProductPageComponentProps = {
  ...
  updateProductApiRequest(id: number, inputs: any): Promise<any>;
  ...
  imageDeleteHandler(imgHandle: any, id: number): Promise<any>;
                  ...
                  product.images.map((image: any, idx: any) => (
                    <Col key={idx} style={{ position: 'relative' }} xs={3}>
                      ...
                      <i
                        ...
                        onClick={() =>
                          imageDeleteHandler(image.path, Number(id)).then((data: any) =>
