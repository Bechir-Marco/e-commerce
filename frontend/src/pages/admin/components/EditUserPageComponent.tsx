...
type EditUserPageComponentProps = {
    updateUserApiRequest: (id: string, name: string, lastName: string, email: string, isAdmin: boolean) => Promise<any>;
    fetchUser: (id: string) => Promise<any>;
}
const EditUserPageComponent = ({ updateUserApiRequest, fetchUser }: EditUserPageComponentProps) => {
