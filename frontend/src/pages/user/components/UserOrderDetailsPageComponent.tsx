...
type UserOrderDetailsPageComponentProps = {
  userInfo: any;
  getUser(): Promise<any>;
...
const UserOrderDetailsPageComponent = ({
  ...
  getOrder,
  loadPayPalScript,
}: UserOrderDetailsPageComponentProps) => {
  ...
  const updateStateAfterOrder = (paidAt: boolean) => {
    setOrderButtonMessage('Thank you for your payment!');
    setIsPaid(paidAt);
    setButtonDisabled(true);
    if (paypalContainer.current) {
      (paypalContainer.current as HTMLElement).style.display = 'none';
    }
  };
  function removeFromCartHandler(a: any, b: any, c: any) {
    throw new Error('Function not implemented.');
  }

  function changeCount(a: any, b: any): void {
    throw new Error('Function not implemented.');
  }
