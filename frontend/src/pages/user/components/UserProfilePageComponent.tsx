...
type updateUserApiRequestProps = {
  ...
  fetchUser(id: any): Promise<any>;
  userInfoFromRedux: any;
  reduxDispatch: any;
  setReduxUserState: any;
  localStorage: any,
  sessionStorage: any;
};
const UserProfilePageComponent: React.FC<updateUserApiRequestProps> = ({
  updateUserApiRequest,
  fetchUser,
  userInfoFromRedux,
  reduxDispatch,
  ...
  const handleSubmit = (event: any) => {
    ...
    if (
      ...
      updateUserApiRequest(
        ...
        .catch((er) =>
          setUpdateUserResponseState({success:'',
            error: er.response
          })
        );
    }
