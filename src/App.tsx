      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedRoutesComponenet />} >
            ...
            <Route path='/admin/orders-details' element={<AdminOrdersDetailsPage />} />
